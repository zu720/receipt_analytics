...
<head>
  ...
  <style>
    ...
    *{ box-sizing:border-box; }
    ...
    h1{ font-size:16px; margin:0 0 6px 0; letter-spacing:.2px; }
    ...
    .listBody{/* 画面の高さに追従（左のレシート一覧がはみ出さない） */
...
<body>
  <div class="wrap">
    ...
    <div class="card">
      <h1>レシート見える君（トモズ）</h1>
      <div class="sub">会員×日時×店舗で擬似レシートを作り、レシート単位で明細を閲覧する検証ツール</div>
    ...
    <div class="card">
      ...
      <div style="margin-top:12px" class="row4">
        ...
        <div>
          <label>メーカー/取引先</label>
          <select id="makerFilter"><option value="">（全て）</option></select>
        </div>
        <div>
          <label>大分類</label>
